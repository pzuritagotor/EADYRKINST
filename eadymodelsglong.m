function [cost,sol]=eadymodelsglong(K,c,eadyparams)

% Integrates the simplified Eady model (the semigeostrophic longwave approximation in the supplemental
% material) of Zurita-Gotor and Held (2026), and evaluates the cost function. 
%
% [cost,sol]=eadymodelsglong(K,c,[eadyparams])
%
...
%
% Output arguments are the value of the cost function (cost, defined by Eq. 6 of the supplemental material)  
% and the full solution to the ODE (sol). This is a structure consisting of the following fields:
...
cost=(U-c)*(1+U-c)*u(end,1)-u(end,2)*((L-Lambda)/K^2-(U-c)^2/L);  %Eq. 6 of supplemental
